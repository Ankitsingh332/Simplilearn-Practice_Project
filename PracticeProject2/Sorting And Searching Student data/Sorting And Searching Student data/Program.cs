...
namespace Sorting_And_Searching_Student_data
{
            ...
            static void Main(string[] args)
            {
                ...
                switch (ss)
                {
                    case 1:
                        ...
                        string textFile = "D:\\Mphasis\\Practice Project\\StudentData1.txt";
                        ...
                        // Write to file
                        File.WriteAllLines("D:\\Mphasis\\Practice Project\\StudentData2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                        ...
                        // Write to file
                        File.WriteAllLines("D:\\Mphasis\\Practice Project\\StudentData3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    case 2:
                        ...
                        string[] words = File.ReadAllText("D:\\Mphasis\\Practice Project\\StudentData1.txt").Split(' ');
